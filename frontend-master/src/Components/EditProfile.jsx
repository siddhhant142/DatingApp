  ...
  const saveProfile = async () => {
    ...
    try {
      const res = await axios.post(
         "https://datingapp-backend-pdji.onrender.com/profile/edit",
        {
          firstName,
          lastName,
          photoURL,
    ...
    headers: {
      ...
      setShowToast(true); //showtoast is for pop notification that profile is saved
      setTimeout(() => {
        setShowToast(false);
      }, 3000);
    } catch (error) {
...
// <UserCard user={{ firstName, lastName, photoURL, about, age, gender , skills }} will show the card of user for preview while editing profile